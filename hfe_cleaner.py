...
nagihara_data=ingest_nagihara_2019(nagihara_data,'./source/nagihara/pds')
...
write_split_hfe(data_split,'./split')
...
write_deep_hfe(data_depth, './depth')
